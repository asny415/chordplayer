        ...
        for action in actions {
            ...
            case .playNote(let note, let offTime):
                ...
                if noteOffTimeMs > noteOnTimeMs {
                    eventIDs.append(midiManager.scheduleNoteOn(note: midiNoteNumber, velocity: velocity, scheduledUptimeMs: noteOnTimeMs))
                    eventIDs.append(midiManager.scheduleNoteOff(note: midiNoteNumber, velocity: 0, scheduledUptimeMs: noteOffTimeMs))
                }
            ...
            case .slide(let fromNote, let toNote, let offTime):
                ...
                eventIDs.append(midiManager.scheduleNoteOn(note: startMidiNote, velocity: velocity, scheduledUptimeMs: noteOnTimeMs))
                ...
                if slideDurationBeats > 0 {
                    ...
                    for step in 0...pitchBendSteps {
                        ...
                        eventIDs.append(midiManager.schedulePitchBend(value: UInt16(intermediatePitch), scheduledUptimeMs: bendTimeMs))
                    }
                }
                
                eventIDs.append(midiManager.scheduleNoteOff(note: startMidiNote, velocity: 0, scheduledUptimeMs: noteOffTimeMs))
                eventIDs.append(midiManager.schedulePitchBend(value: 8192, scheduledUptimeMs: noteOffTimeMs + 1))
                ...
                if vibratoDurationBeats > 0.1 {
                    ...
                    if totalSteps > 0 {
                        for step in 0...totalSteps {
                            ...
                            eventIDs.append(midiManager.schedulePitchBend(value: UInt16(pitchBendValue), scheduledUptimeMs: bendTimeMs))
                        }
                    }
                }
